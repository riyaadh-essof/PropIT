<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/master.Master" CodeBehind="Properties.aspx.vb" Inherits="ABSA.Properties" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Button ID="btn"  text="hello" runat="server" />
  <div class='row'>
     <div class='col-md-4'>
      <div class="single">
		<div class="container" style="align-self:center;">
			...
			<div class="col-md-4 single-left">
                <div style="padding:10px; border:1px solid Red;" >
                    <h3 style="text-align:center"> Tanoos Left Tit goes here</h3> 
                    <br/> 
				<div class="sample1">
